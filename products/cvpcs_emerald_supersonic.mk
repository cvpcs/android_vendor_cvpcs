...
PRODUCT_BUILD_PROP_OVERRIDES := \
        BUILD_DATE_UTC=1291806540 \
        BUILD_DISPLAY_ID=3.70.651.1 \
        BUILD_FINGERPRINT=sprint/htc_supersonic/supersonic/supersonic:2.2/FRF91/294884:user/release-keys \
        BUILD_ID=FRF91 \
        BUILD_NUMBER=294884 \
        BUILD_VERSION_TAGS=release-keys \
        PRIVATE_BUILD_DESC="3.70.651.1 CL294884 release-keys" \
...
PRODUCT_PROPERTY_OVERRIDES += \
	...
	ro.cvpcs.scriptybox.files_url=http://files.ccroms.net/emerald/gingerbread/$(build_version)
