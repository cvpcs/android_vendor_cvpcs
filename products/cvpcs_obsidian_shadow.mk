...
PRODUCT_BUILD_PROP_OVERRIDES := \
	...
	PRIVATE_BUILD_DESC="cdma_shadow-user 2.2 VZW 2.3.9 ota-rel-keys,release-keys" \
	BUILD_FINGERPRINT=verizon/shadow_vzw/cdma_shadow/shadow:2.2/VZW/23.9:user/ota-rel-keys,release-keys
